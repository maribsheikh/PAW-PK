...
const Home = () => {
  ...
  const features = [
    ...
    {
      title: 'Easy to Clean',
      description: 'Waterproof and stain-resistant surfaces for hassle-free maintenance',
      icon: '🧽'
    },
    {
    ...
    <div>
      ...
      <section className="bg-gradient-to-br from-primary-600 via-primary-500 via-accent-500 to-accent-600 text-white py-24">
        <div className="container mx-auto px-4 text-center">
          ...
          <Link to="/products" className="inline-block bg-white text-primary-600 hover:bg-primary-50 font-bold text-lg px-10 py-4 rounded-lg transition-all transform hover:scale-105 shadow-xl">
            Shop Now
          </Link>
        </div>
      </section>
      ...
      <section className="py-16 bg-gradient-to-b from-gray-50 to-white">
        <div className="container mx-auto px-4">
          <h2 className="text-4xl font-bold text-center mb-12 text-gray-900">Why Choose Our Mats?</h2>
