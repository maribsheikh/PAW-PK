...
const ProductDetail = () => {
  ...
  const getDisplayImages = () => {
    ...
    if (
      selectedColor &&
      product.imageColors &&
      product.imageColors[selectedColor]
    ) {
  ...
  const availableColors = product.imageColors
    ? Object.keys(product.imageColors)
    : [];
          ...
          {selectedVariant ? (
            <div className="flex items-center gap-3 mb-4">
              <span className="text-2xl text-gray-400 line-through">
                {formatPrice(selectedVariant.price_pkr * 2)}
              </span>
              <span className="text-2xl font-bold text-primary-600">
                {formatPrice(selectedVariant.price_pkr)}
              </span>
            </div>
          ) : (
            <div className="flex items-center gap-3 mb-4">
                  ...
                  >
                    ...
                    <div className="flex items-center gap-2">
                      <span className="text-lg text-gray-400 line-through">
                        {formatPrice(variant.price_pkr * 2)}
                      </span>
                      <span className="font-bold text-primary-600 text-lg">
                        {formatPrice(variant.price_pkr)}
                      </span>
                    </div>
