  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await api.post('/orders', {
        ...
        paymentMethod,
        items: cart.items,
        cardInfo: paymentMethod === 'stripe' || paymentMethod === 'card' ? cardInfo : null
      });
              ...
              <div className="space-y-3">
                ...
                <label className="flex items-center p-4 border rounded cursor-pointer hover:bg-gray-50">
                  ...
                  <div>
                    ...
                    <div className="text-sm text-gray-600">Secure card payment</div>
                  </div>
                </label>
              </div>
                ...
                <div className="mt-6 p-4 border rounded-lg bg-gray-50">
                  ...
                  <div className="space-y-4">
                    <div>
                      ...
                      <input
                        type="text"
                        required={paymentMethod === 'card' || paymentMethod === 'stripe'}
