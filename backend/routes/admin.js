...
router.post(
  ...
  async (req, res, next) => {
    try {
      ...
      const { title, sku, description, price_pkr, category, stock, variants } =
        req.body;
...
router.put(
  ...
  async (req, res, next) => {
    try {
      ...
      if (req.body.price_pkr)
        updates.price_pkr = parseFloat(req.body.price_pkr);
      if (req.body.category) updates.category = req.body.category;
      if (req.body.stock !== undefined)
        updates.stock = parseInt(req.body.stock);
